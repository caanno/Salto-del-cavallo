...
if st.session_state.start_pos is None:
    ...
    st.markdown("<h6 style='text-align: center; color: gray;margin-top:-15px;'>Scegli la casella da cui partire e visualizza il percorso del cavallo sulla scacchiera</h3>", unsafe_allow_html=True)
